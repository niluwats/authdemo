...
import com.nw.authdemo.entity.Role;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public UserDto saveUser(RegisterDto registerDto) {
        ...
        if (optionalUser.isPresent()) {
            throw new IllegalStateException("user with email '" + registerDto.getEmail() + "' already exists");
        }
        ...
        emailService.send(registerDto.getEmail(), buildEmail(registerDto.getName(), link));
